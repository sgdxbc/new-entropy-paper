data availability guarantees\section{Introduction}
\label{sec:intro}
...
\lijl{This paragraph can be further shortened.}
...
Since Byzantine nodes cannot be reliably identified, a system needs to provision each group separately to defend against adversarial power.
The approach leads to a fundamental trade-off: either over-provision all groups for potential attacks, or sacrifice data availability of some groups.

In this work, we propose a novel design principle of DSNs: a \emph{node-centric} approach that allows defense to ``track'' Byzantine nodes across placement groups.
