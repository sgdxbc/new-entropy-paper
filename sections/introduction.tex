...
Since Byzantine behavior cannot be reliably identified, a system needs to provision each group to defend against adversarial power from potentially all Byzantine nodes.
