...
As discussed in \cref{sec:impl}, \sys nodes can optionally cache chunk data to reduce repair traffic.
...
\cref{fig:repair} also shows total repair traffic in the first year with increasing node churn rate.
...
\cref{fig:time} plots the number of fragments stored on honest \sys nodes over time, and the two lines are deployments with different inner code parameters.
