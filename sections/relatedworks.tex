...
As mentioned in \autoref{sec:motivation}, our work is related to a long line of research and production systems in distributed storage~\cite{ceph,gfs,bigtable,dynamo,liquid,amazon-s3,amazon-glacier,google-storage,google-cloudstore,google-coldline}.
...
As detailed in \autoref{sec:motivation}, IPFS~\cite{filecoin} uses DHT to store publisher record without centralization, but offers no mechanism to reliably store objects.
